...
<%@page import="com.entity.Movie_CinemaEntity"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
<% ArrayList<ArrayList<Movie_CinemaEntity>> moviecinelist = (ArrayList<ArrayList<Movie_CinemaEntity>>)request.getAttribute("moviecinelist"); %>
<!DOCTYPE html>
         ...
         height: 100%;
      	...
      	<script type="text/javascript">
	   	...
	   	$(document).ready(function(){
 	   		$("#mclist").hide(); //영화 상영정보 숨김
	   		$(".movieCd").click(function(){
	   			var movieCd = $(this).text();
	   			alert(movieCd);
	   			$.ajax({
	   	  			url: "movieIsRun.do",
	   	  			dataType: "json",
	   				...
	   				$("#mclist").show(); //영화 상영정보 보임
	   				$("#mclist tbody").empty(); // 테이블 내용 초기화
	   				$.each(json,function(key,mclist){
	   					$("#mclist tbody").append("<tr>");
	   					$("#mclist tbody").append("<td>"+ mclist.movieCd +"</td>");
	   					$("#mclist tbody").append("<td>"+ mclist.cinemaID +"</td>");
	   					$("#mclist tbody").append("<td>"+ mclist.screenID +"</td>");
	   					$("#mclist tbody").append("<td>"+ mclist.m_cvo.isRun +"</td>");
	   					$("mclist tbody").append("</tr>");
	   				})//ends $.each
	   			})
...
<!-- ******************************************************************************** -->
	...
	<div>
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center" colspan="3"><a href="movieInsert.do">추가</a></td>
						<td colspan="3" style="text-align: center"><a onclick="ch_title();">수정</a></td>	
		...
		<div>
			<table id="mclist" class="table-bordered">
				<thead>
					<tr>
						<td>영화코드</td>
						<td>영화관</td>
